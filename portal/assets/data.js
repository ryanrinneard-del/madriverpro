...
RRG.WEEKS = [
  ...
  {
    n: 7, date: 'Tue Jul 7 / Fri Jul 10, 2026', phase: 'P2', open: '2026-07-04',
    title: 'Putting — Distance Control',
    codes: ['08', '09'],
    focus: 'Lag-ladder drills. 30 / 40 / 50\u202fft landing zones. Eliminate the 3-putt. Tue installs, Fri pressure-tests with a game. 15\u202fmin short game + inside-6\u202fft putting built into every session.',
  ...
  {
    n: 8, date: 'Tue Jul 14 / Fri Jul 17, 2026', phase: 'P2', open: '2026-07-11',
    title: 'On-Course Strategy & Playing Lesson',
    codes: ['10'],
    focus: '<b>Playing lesson</b> on Friday — coach walks the round, narrates decisions, coaches in real time. Formats rotate across the summer: <b>par-3 scramble</b> (two balls, pick the best of each), <b>worst-ball 9</b> (play two balls, count the worst of each), <b>stroke-play with commentary</b> (real scores, running coaching dialogue).',
  ...
  {
    n: 9, date: 'Tue Jul 21 / Fri Jul 24, 2026', phase: 'P2', open: '2026-07-18',
  ...
  {
    n: 10, date: 'Tue Jul 28 / Fri Jul 31, 2026', phase: 'P2', open: '2026-07-25',
    ...
    context: 'SCJGT Event #5 falls on the Wed of this week. Friday is a decompression + debrief session.',
    selfGuided: 'Play Event #5 plus one more 18-hole round. Tiger 5 mental scorecard on both. Full scorecard submitted.',
    tools: ['tiger5', 'scorecard'],
  },
  {
    n: 11, date: 'Tue Aug 4 only — no Friday session (Polair Nationals week)', phase: 'P2', open: '2026-08-01',
    ...
    context: 'Polair National Championship week (Aug 7–10) at Tangle Creek for the boys who qualified — Ryan is on-site with them. Tuesday is the only Mad River session this week. Prep for SCJGT Event #6 (Mon Aug 10) at National Pines built into the Tuesday block.',
  ...
  {
    n: 12, date: 'Tue Aug 11 / Fri Aug 14, 2026', phase: 'P2', open: '2026-08-08',
  ...
  {
    n: 13, date: 'Tue Aug 18 / Fri Aug 21, 2026', phase: 'P2', open: '2026-08-15',
    title: 'Tournament Week — Simplify Under Pressure',
    codes: ['12'],
    focus: 'Pre-tournament game plan Tuesday. Post-tournament debrief Friday. One-swing-thought, one-target discipline. The mental scorecard is the focus of the week.',
  ...
  {
    n: 14, date: 'Tue Aug 25 / Fri Aug 28, 2026', phase: 'P2', open: '2026-08-22',
    title: 'Championship Week — Peak Performance',
    codes: ['10', '11', '12'],
    focus: 'Tuesday is the championship game plan. Friday is the full post-season review. Individual performance summary from the season\u2019s submitted scorecards.',
  ...
  {
    n: 15, date: 'Tue Sep 1 / Fri Sep 4, 2026', phase: 'P2', open: '2026-08-29',
